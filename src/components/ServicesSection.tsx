...
const services = [
  {
    ...
    description: 'Oczyszczanie i harmonizacja\nczakr oraz aury',
    backDescription: 'Bezpośrednia praca z polem energetycznym pacjenta. Usuwanie blokad, zasilanie organów energią witalną i przywracanie homeostazy.',
  ...
  },
  {
    ...
    subtitle: 'Kwantowa',
    description: 'Metoda Dwupunktowa\ni praca z intencją',
    backDescription: 'Transformacja rzeczywistości poprzez pole serca i świadomości. Szybkie zmiany wzorców i przekonań na poziomie kwantowym.',
  ...
  },
  {
    ...
    description: 'Pełna skuteczność\nbez kontaktu fizycznego',
    backDescription: 'Energia nie zna granic czasu i przestrzeni. Sesje online są równie skuteczne co spotkania osobiste, idealne dla osób z zagranicy.',
  ...
  },
  {
    ...
    description: 'Harmonia w domu\ni w związkach',
    backDescription: 'Energetyczne oczyszczanie mieszkań z ciężkich energii oraz uzdrawianie toksycznych relacji i węzłów karmicznych.',
